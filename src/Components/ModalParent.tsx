                ...
                <div className="w-screen border-2 border-beta-700 relative p-3 inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <div className="bg-white px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    {props.handleSubmit && <div>
                      ...
                      <button
                        type="button"
                        className="mt-3 lg:mt-0 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-yellow-400 text-base font-medium text-red-700 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-300 sm:ml-3 sm:w-auto sm:text-sm"
