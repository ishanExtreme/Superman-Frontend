        ...
        <div className="container-fluid w-full flex flex-row flex-wrap items-center justify-between px-6">
            ...
            <div className="flex items-center relative lg:order-last">
                ...
                <div className="dropdown relative">
                    ...
                    <li>
                        <a className="flex items-center gap-x-1 dropdown-item text-sm py-2 px-4 font-normal w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 " href="/profile">
